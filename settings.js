...
module.exports = {
    OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94704979846' : process.env.OWNER_NUMBER, //ADD YOUR NUMBER
    SESSION_ID: process.env.SESSION_ID === undefined ? '𝕃𝔸ℝ𝔸-𝕄𝔻=2ZwxEKwI#SCakgjKp-TGuerkIqD-G9LgPQZeUfhBYgWLm4KtsIPo' : process.env.SESSION_ID, //ADD YOUR SSION ID
